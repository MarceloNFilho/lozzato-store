const Loading = () => {
  return (
    <>
      <div className="mb-6 h-36 w-full rounded-lg bg-accent opacity-75 max-lg:hidden lg:h-[396px] xl:h-[463px]" />
      <div className="flex w-full max-w-[1280px] animate-pulse flex-col gap-8 max-xl:px-5 max-lg:py-8 lg:mx-auto lg:pb-8">
        <div className="h-36 w-full rounded-lg bg-accent opacity-75 lg:hidden lg:h-[396px] xl:h-[500px]" />
